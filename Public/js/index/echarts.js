...
//              return !multipleSeries ? (seriesName && encodeHTML(seriesName) + '<br />') +(name ? encodeHTML(name) + ' : ' + formattedValue : formattedValue) : colorEl + encodeHTML(this.name) + ' : ' + formattedValue;
                var timerName;
                console.log(encodeHTML(name).length)
                if(encodeHTML(name).length<6){
                	
                	if(encodeHTML(name).substr(0,2)-1<10){
                		console.log(2)
                	timerName="0"+encodeHTML(name).substr(0,2)-1+":00~";
	                }else{
	                	timerName=encodeHTML(name).substr(0,2)-1+":00~";
	                }
                }
                return !multipleSeries ? (name ?timerName+ encodeHTML(name)+ '<br />'+(seriesName && encodeHTML(seriesName) ) + ' : ' + formattedValue : formattedValue) : colorEl + encodeHTML(this.name) + ' : ' + formattedValue;
            },
