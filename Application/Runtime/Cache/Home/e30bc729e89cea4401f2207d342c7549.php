                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <ul class="top_list" id="top_list">
                            <li <?php if($status == 0): ?>class="tag_border"<?php endif; ?> ><a href="<?php echo (C("QS_BASE_PATH")); ?>/UserPay/listApply/status/0">已申请</a></li>
                            <li <?php if($status == 1): ?>class="tag_border"<?php endif; ?> ><a href="<?php echo (C("QS_BASE_PATH")); ?>/UserPay/listApply/status/1">已付款</a></li>
                            <li <?php if($status == 2): ?>class="tag_border"<?php endif; ?> ><a href="<?php echo (C("QS_BASE_PATH")); ?>/UserPay/listApply/status/2">已拒绝</a></li>
                        ...
                        <div class="box-body">
                            <table id="example2" class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th>审批时间</th>
                                    <th>审批结果</th>
                                    <th width="180">操作&nbsp;  <!--<a href="<?php echo (C("QS_BASE_PATH")); ?>/UserPay/entry" class="a0 btn_style btn1">添加</a>--></th>
                                </tr>
                                </thead>
                                <tbody>

                                <?php if(is_array($payList)): $i = 0; $__LIST__ = $payList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pay): $mod = ($i % 2 );++$i;?><tr>
                                        <td><?php echo ($key+1); ?></td>
                                        <td><?php echo ($pay["mobile"]); ?></td>
                                        <td><?php echo ($pay["apply_name"]); ?></td>
                                        <td><?php echo ($pay["money"]); ?></td>
                                        <td><?php echo ($pay["receive_account"]); ?></td>
                                        <td><?php echo ($pay["receiver_name"]); ?></td>
                                        <td><?php echo ($pay["apply_date"]); ?></td>
                                        <!--<td><?php echo ($pay["apply_reason"]); ?></td>-->
                                        <td><?php echo ($pay["approver_name"]); ?></td>
                                        <td><?php echo ($pay["opt_reason"]); ?></td>
                                        <td><?php echo ($pay["pay_account"]); ?></td>
                                        <td><?php echo ($pay["transaction_no"]); ?></td>
                                        <td><?php echo ($pay["pay_time"]); ?></td>
                                        <td>
                                            <?php if($pay['approvve_status'] == 0): ?>已申请<?php endif; ?>
                                            <?php if($pay['approvve_status'] == 1): ?>已付款<?php endif; ?>
                                            <?php if($pay['approvve_status'] == 2): ?>已拒绝<?php endif; ?>
                                        </td>
                                        <td>
                                            <a href="<?php echo (C("QS_BASE_PATH")); ?>/UserPay/entry/id/<?php echo ($pay["id"]); ?>" class="a0 btn_style btn1">详细</a>
                                        </td>
