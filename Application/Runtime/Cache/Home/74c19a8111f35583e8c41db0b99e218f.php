                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <ul class="top_list" id="top_list">
                            <li <?php if($status == 1): ?>class="tag_border"<?php endif; ?> ><a href="<?php echo (C("QS_BASE_PATH")); ?>/UserPay/listPay/status/1">已支付</li>
                            <li <?php if($status == 0): ?>class="tag_border"<?php endif; ?> ><a href="<?php echo (C("QS_BASE_PATH")); ?>/UserPay/listPay/status/0">待支付</a></li>
                        </ul>
                        ...
                        <div class="box-body">
                            <table id="example2" class="table table-bordered">
                                ...
                                <?php if(is_array($payList)): $i = 0; $__LIST__ = $payList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pay): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo ($pay["bookname"]); ?></td>
                                        <td><?php echo ($pay["or_id"]); ?></td>
                                        <td><?php echo ($pay["order_no"]); ?></td>
                                        <td><?php echo ($pay["order_time"]); ?></td>
                                        <td><?php echo ($pay["pay_time"]); ?></td>
                                        <td><?php echo ($pay["transaction_no"]); ?></td>
                                        <td>
                                            <?php if($pay['status'] == 0): ?>待支付<?php endif; ?>
                                            <?php if($pay['status'] == 1): ?>已支付<?php endif; ?>
                                        </td>
                                        <td>
