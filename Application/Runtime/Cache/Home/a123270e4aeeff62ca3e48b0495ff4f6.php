                        ...
                        <div class="box-body">
                            <table id="example2" class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th>条件</th>
                                    <th>状态</th>
                                    <th width="180">操作&nbsp;<a href="<?php echo (C("QS_BASE_PATH")); ?>/AuthRule/entry" class="a0 btn_style btn1">添加</a></th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                <?php if(is_array($ruleList)): $i = 0; $__LIST__ = $ruleList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rule): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                            <?php if($rule['status'] == 0): ?>无效<?php else: ?>有效<?php endif; ?>
                                        </td>
                                        <td>
                                            <div class="btn-group">

                                                <a href="<?php echo (C("QS_BASE_PATH")); ?>/AuthRule/entry/id/<?php echo ($rule["id"]); ?>" class="a0 edit">编辑</a>&nbsp;

                                                <!--<?php if($rule['status'] == 0): ?>-->
                                                    <!--<a href="#" onclick="if(window.confirm('你确定要启用吗？')){window.location.href='<?php echo (C("QS_BASE_PATH")); ?>/AuthRule/del/id/<?php echo ($rule["id"]); ?>/status/1' }">启用</a>-->
                                                    <!--<?php else: ?>-->
                                                    <!--<a href="#" onclick="if(window.confirm('你确定要禁用吗？')){window.location.href='<?php echo (C("QS_BASE_PATH")); ?>/AuthRule/del/id/<?php echo ($rule["id"]); ?>status/0' }">禁用</a>-->
                                                <!--<?php endif; ?>-->
