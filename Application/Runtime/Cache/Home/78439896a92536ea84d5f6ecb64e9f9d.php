                        ...
                        <div class="box-body">
                            <table id="example2" class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th>是否可编辑</th>
                                    <th>状态</th>
                                    <th width="180">操作&nbsp;<a href="<?php echo (C("QS_BASE_PATH")); ?>/AuthGroup/entry" class="a0 btn_style btn1">添加</a></th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                <?php if(is_array($groupList)): $i = 0; $__LIST__ = $groupList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                            <?php if($group['is_edit'] == 1): ?>可编辑<?php endif; ?>
                                            <?php if($group['is_edit'] == 0): ?>不编辑<?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if($group['status'] == 0): ?>无效<?php else: ?>有效<?php endif; ?>
                                        </td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <?php if($group['is_edit'] == 1): ?><a href="<?php echo (C("QS_BASE_PATH")); ?>/AuthGroup/entry/id/<?php echo ($group["id"]); ?>" class="a0 edit">编辑</a>&nbsp;

                                                    <?php if($group['status'] == 0): ?><a href="#" onclick="if(window.confirm('你确定要启用吗？')){window.location.href='<?php echo (C("QS_BASE_PATH")); ?>/AuthGroup/del/id/<?php echo ($group["id"]); ?>/status/1' }" class="a0 forbid">启用</a>
                                                    <?php else: ?>
                                                        <a href="#" onclick="if(window.confirm('你确定要禁用吗？')){window.location.href='<?php echo (C("QS_BASE_PATH")); ?>/AuthGroup/del/id/<?php echo ($group["id"]); ?>status/0' }" class="a0 forbid">禁用</a><?php endif; endif; ?>
