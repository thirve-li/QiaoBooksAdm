...
class AlibabaAliqinFcSmsNumSendRequest
{
	...
	public function check()
	{
		...
		\Top\RequestCheckUtil::checkNotNull($this->recNum,"recNum");
		\Top\RequestCheckUtil::checkNotNull($this->smsFreeSignName,"smsFreeSignName");
		\Top\RequestCheckUtil::checkNotNull($this->smsTemplateCode,"smsTemplateCode");
		\Top\RequestCheckUtil::checkNotNull($this->smsType,"smsType");
	}
